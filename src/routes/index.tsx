  ...
  return (
    <main className={styles.common}>
      <section>
        ...
        <p>
          This React app compares three client-side detection and tracking approaches: background
          subtraction, HSV color segmentation, and MediaPipe Tasks Vision. <br />
          Camera frames are processed locally and are not uploaded.
        </p>
        <div>
          <a
            href="https://github.com/5h0utat0t2uka/vision-tracker"
            target="_blank"
          ...
          <Link to="/privacy">
            <svg width={32} height={32} viewBox="0 0 32 32">
              <g fill="none">
                <path
                  fill="url(#SVG0YxGxeQs)"
                  d="M16.555 2.168a1 1 0 0 0-1.11 0C12.53 4.112 8.685 6.027 3.901 6.505A1 1 0 0 0 3 7.5V16c0 3.88 2.124 7.17 4.701 9.546c2.572 2.372 5.737 3.971 8.115 4.417l.184.034l.184-.034c2.378-.446 5.543-2.045 8.115-4.417C26.876 23.17 29 19.88 29 16V7.5a1 1 0 0 0-.9-.995c-4.785-.478-8.63-2.393-11.545-4.337"
                ></path>
                <defs>
                  <radialGradient
                    id="SVG0YxGxeQs"
                    ...
                    cy={0}
                    r={1}
                    gradientTransform="rotate(53.644 9.989 -14.008)scale(67.3559 60.0838)"
        ...
        <nav aria-label="Tracking methods">
          <ul>
            <li>
              ...
              <span>
                機械学習モデルやAIを利用せず 背景差分を利用して動体検出して追跡する Blob Track
                の実装
              </span>
            </li>
            <li>
              ...
              <span>
                機械学習モデルやAIを利用せず HSV色空間で特定の色の領域を検出して追跡する Blob Track
                の実装
              </span>
            </li>
            <li>
              <Link to="/mediapipe-tasks-vision">
                MediaPipe Tasks Vision Object Detection Tracking
              </Link>
              <span>
                軽量な量子化済み学習モデルを利用して、特定のオブジェクト(人間・車・自転車のプリセット)を検出して追跡を行う
                MediaPipe Tasks Vision の実装
              </span>
            </li>
          </ul>
        </nav>
  ...
  return (
    <main className={styles.common}>
      <section>
        <h1>Privacy</h1>
        <p>
          すべてのページのカメラ映像はブラウザ上で処理され、外部へは送信されません。
          <br />
          <a
          ...
          のページでは、性能および利用状況に関するメトリクスが Google へ送信されます。
        </p>
        <p>
          詳細は{" "}
          <a
            href="https://developers.google.com/edge/mediapipe/solutions/tasks?utm_source=chatgpt.com#mediapipe_tasks_privacy_notice"
            target="_blank"
            rel="noopener noreferrer"
          >
            MediaPipe Tasks のドキュメント
          </a>{" "}
          または{" "}
