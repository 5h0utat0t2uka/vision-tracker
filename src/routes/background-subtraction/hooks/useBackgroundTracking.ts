...
export function useBackgroundTracking({
  ...
  heatmap, cameraStatus, stopCamera, settings, targetFps, analysisLongEdge,
  ...
  }, [cameraStatus, stopCamera, analysisLongEdge, heatmap, videoRef, analysisCanvasRef, filterCanvasRef, overlayCanvasRef, stageRef])
